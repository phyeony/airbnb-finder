...
def count_overlapping_features(gdf: gpd.GeoDataFrame) -> gpd.GeoDataFrame:
...
#%%
avg = food_intersections['count'].mean() # 32.36
...
food_intersections = food_intersections[food_intersections['count'] >= avg]

# Plot results
food_intersections.explore(m=m)
